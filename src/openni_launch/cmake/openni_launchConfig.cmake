...
if("FALSE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /tmp/buildd/ros-indigo-openni-launch-1.9.7-0trusty-20151216-2247)
  set(openni_launch_DEVEL_PREFIX /tmp/buildd/ros-indigo-openni-launch-1.9.7-0trusty-20151216-2247/obj-x86_64-linux-gnu/devel)
  ...
  set(openni_launch_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Isaac I.Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
